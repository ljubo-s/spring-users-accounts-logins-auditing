...
public class RolesController {
	...
	@RequestMapping(value = "/roles/addRoles/", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/roles/updateRoles/{id}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/roles/saveRoles", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/roles/deleteRoles/{id}", method = RequestMethod.GET)
	...
	public String doActions(@ModelAttribute Roles roles, BindingResult result, @RequestParam String action,
